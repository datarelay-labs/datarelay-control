...
> **Historical inventory notice (current Control scope):** this file was generated from commit `42c4092` and is not current release authority. AI Gateway / AI Proxy / AI Provider / AI Stream and all Phase E rows below are outside DataRelay Control scope and MUST NOT be counted in current capability coverage, E2E totals, blockers, or release readiness. The inventory will be regenerated by Issue #154. Current Full User E2E scope is defined by [`user-lifecycle/FULL-USER-E2E-SCENARIOS.md`](user-lifecycle/FULL-USER-E2E-SCENARIOS.md).
